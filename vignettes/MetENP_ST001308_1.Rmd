...
For ex: in this study, we want to compare Sample_group experimental methods of rid1-knockout strains, so we will compare mut_gly and mut_ile samples
...
```{r}
stats_metabolites = significant_met(metabolomics_data=refmet_class, met_col="metabolite_name",analysis_type="NMR data", metadata=metadata, factor1='mut_gly', factor2='mut_ile', factor_col='Sample_group',sample_col='local_sample_id', p_adjust='fdr',normalization="half_of_min")
