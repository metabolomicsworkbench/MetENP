...
kegg_es = path_enrichmentscore(met_path,sig_metabolites_kegg_id=sig_metabolites_kegg_id,ls_path=ls_path,refmet_class=refmet_class,sps='hsa',padj='fdr', kegg_comp_path=FALSE, debug = 0)
...
```{r}
metenrichment = metclassenrichment(df_metclass=sig_metabolites_kegg_id, refmet_names, metclass= 'sub_class',enrich_stats="HG",no=1, debug = 0)
