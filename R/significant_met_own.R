...
significant_met_own <- function(metabolomics_data,met_col,
...
analysis_selected=metabolomics_data
...
results2= merge(results, refmet_class2, by.y='metabolite_name', by.x='Metabolite')
  ...
  results2[,"pval"]= as.numeric(paste(results2[,"pval"]))
  results2[,"log2Fold_change"]= as.numeric(paste(results2[,"log2Fold_change"]))
